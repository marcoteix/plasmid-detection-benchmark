...
TOOL_CMAP = {
    'PlaScope': (0.00392156862745098, 0.5294117647058824, 0.0),
    'Plasmer': (0.4196078431372549, 0.0, 0.30980392156862746),
    'PlasmidEC': (0.0, 0.0, 0.8666666666666667),
    'gplas2': (0.8392156862745098, 0.0, 0.0),
    ...
    "MOB-suite": (0.592156862745098, 1.0, 0.0),
    "PlasBin-Flow": (1.0, 0.6470588235294118, 0.1843137254901961)
}
BEST_TOOLS = ["PlaScope", "Plasmer", "PlasmidEC", "gplas2"]
